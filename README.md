...
[![Version 5.17.0-rc.4](https://img.shields.io/badge/version-5.17.0--rc.4-green.svg)](VERSION)
...
|---------|------|-------------|
| 5.17.0-rc.4 | 2026-05-12 | **fix(ci): use current Anthropic Sonnet direct smoke model.** Updates the real-provider integration matrix from retired `anthropic::claude-3-5-haiku-20241022` to `anthropic::claude-sonnet-4-6` for both basic chat and provider-isolation checks, keeping provider `not_found_error` failures visible instead of treating them as environmental skips. |
