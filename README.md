...
[![Version 6.61.1](https://img.shields.io/badge/version-6.61.1-green.svg)](VERSION)
...
Older releases are preserved in Git tags and GitHub releases. Older 6.x rows (including 6.56.0, 6.55.0, 6.54.0, 6.53.4, 6.53.0 and 6.51.0), the 5.2.0 through 5.33.0-rc.6 rows, and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
